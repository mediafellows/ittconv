...
func TestParseSMPTETimecode(t *testing.T) {
	tests := []struct {
		...
		{name: "Valid Timecode", input: "01:02:03:04", expected: &SMPTETimecode{Hours: 1, Minutes: 2, Seconds: 3, Frames: 4}, expectErr: false},
		{name: "Zero Timecode", input: "00:00:00:00", expected: &SMPTETimecode{Hours: 0, Minutes: 0, Seconds: 0, Frames: 0}, expectErr: false},
		{name: "Max Values", input: "23:59:59:29", expected: &SMPTETimecode{Hours: 23, Minutes: 59, Seconds: 59, Frames: 29}, expectErr: false},
...
func TestToMilliseconds(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "00:00:00:00 @ 24fps", timecode: &SMPTETimecode{0, 0, 0, 0}, framerate: fr24, expected: big.NewRat(0, 1), expectErr: false},
		{name: "00:00:01:00 @ 24fps", timecode: &SMPTETimecode{0, 0, 1, 0}, framerate: fr24, expected: big.NewRat(1000, 1), expectErr: false},
...
func TestMillisecondsToSMPTETimecode(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "0ms @ 24fps", ms: big.NewRat(0, 1), framerate: fr24, expected: &SMPTETimecode{0, 0, 0, 0}, expectErr: false},
		{name: "1000ms @ 24fps", ms: big.NewRat(1000, 1), framerate: fr24, expected: &SMPTETimecode{0, 0, 1, 0}, expectErr: false},
		{name: "500ms @ 24fps", ms: big.NewRat(500, 1), framerate: fr24, expected: &SMPTETimecode{0, 0, 0, 12}, expectErr: false},
		{name: "1500ms @ 24fps", ms: big.NewRat(1500, 1), framerate: fr24, expected: &SMPTETimecode{0, 0, 1, 12}, expectErr: false},
		{name: "2900000/2997ms @ 29.97fps", ms: big.NewRat(2900000, 2997), framerate: fr2997, expected: &SMPTETimecode{0, 0, 0, 29}, expectErr: false},
		{name: "Rounding Up", ms: big.NewRat(499, 1), framerate: fr24, expected: &SMPTETimecode{0, 0, 0, 12}, expectErr: false},   // Should round up to 12 frames
		{name: "Rounding Down", ms: big.NewRat(450, 1), framerate: fr24, expected: &SMPTETimecode{0, 0, 0, 11}, expectErr: false}, // Should round down to 11 frames
...
func TestToClockTime(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "00:00:00:00 @ 24fps, prec 3", timecode: &SMPTETimecode{0, 0, 0, 0}, framerate: fr24, precision: 3, expected: "00:00:00.000", expectErr: false},
		{name: "00:00:01:00 @ 24fps, prec 3", timecode: &SMPTETimecode{0, 0, 1, 0}, framerate: fr24, precision: 3, expected: "00:00:01.000", expectErr: false},
		{name: "00:00:00:12 @ 24fps, prec 3", timecode: &SMPTETimecode{0, 0, 0, 12}, framerate: fr24, precision: 3, expected: "00:00:00.500", expectErr: false},
